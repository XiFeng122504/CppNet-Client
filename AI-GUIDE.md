...
4. **Documentation Discipline**
   - Update `client/LEARNING-LOG.md` after learning sessions (detailed log)
   - Update `OVERVIEW.md` progress tracking
...
**Learning Logs**:
- `OVERVIEW.md` - Project overview, progress tracking, AI guidelines
- `client/LEARNING-LOG.md` - Detailed learning journal with key insights
